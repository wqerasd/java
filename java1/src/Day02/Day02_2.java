...
public class Day02_2 { // c s
		...
		public static void main(String[] args) { // m s
			...
			// p. long : 8바이트 정수 +-20억이상 [ 데이터 뒤에 L ]
			long num5 = 10000000000L; 		System.out.println( num5 );
						// int형 -> long형
			
			// p.47~48 float[ 데이터뒤에 f ] : 4바이트 : 8자리(소수점) / double( 실수 기본타입 ) : 8바이트 : 17자리(소수점)
			double num6 = 3.14; 	System.out.println( num6 );
			float num7 = 3.14f;
			
			double num8 = 0.1234567890123456789111111111; System.out.println( num8 );
			float num9 = 0.123456789123456789111111111f;  System.out.println( num9 );
