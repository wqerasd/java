...
public class Day10_4 {
	...
	// Arraylist [ 자동완성 ]
		...
		// 리스트명.get(인덱스) : 해당 인덱스의 객체를 호출하는 메소드
		System.out.println(" 길이 : " + 리스트이름.size() );
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		
		// 배열 : 메모리의 크기는 고정길이 [ 메모리 효율성 떨어짐 ]
			// 회원배열이 100개 -> 만일 100명 초과하면 저장 불가능
			// 회원배열이 100개 -> 만일 1명이면 나머지 99개 메모리 null
		
		// 리스트 : 메모리 크기는 가변길이 [ 메모리 효율성 좋음 ]
			// 리스트의 기본길이는 10 -> 만일 추가 하거나 삭제하면 자동 메모리 할당
		
		// 배열(문법)				vs 리스트(클래스)
		// 추가메소드x 				vs 추가메소드o
		// 추가 : 배열명[0]			vs 리스트명.add(값)
							// 삽입 : 리스트명.add( 인덱스번호, 값 )
