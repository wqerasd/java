...
public class Day04_4 { // c s
	...
	public static void main(String[] args) { // m s
		...
		// 배열내 0번 인덱스부터 끝 인덱스까지 하나씩 임시변수에 대입 반복처리
				...
				System.out.println(" scores[0] : " + scores[0] ); // 1번 인덱스의 데이터 호출
				System.out.println(" scores[1] : " + scores[1] ); // 2번 인덱스의 데이터 호출
				System.out.println(" scores[2] : " + scores[2] ); // 3번 인덱스의 데이터 호출
