...
public class Day03_4 { // c s
	...
	public static void main(String[] args) { // m s
		...
		// 제어문 : 1. if문 2. switch문
			//if : 논리검사( true 혹은 false )  	     / 경우의 수 정해져 있지 않는경우
		...
		// break; : 가장 가까운 swtich 혹은 반복문 탈출[나가기]
			...
			// 예1) 점수가90점 이면 A 80점이면 B 70점이 C 그외 탈락
			int 점수 = 80;
			...
			// 문제1 ) 국어, 영어, 수학 점수를 입력받아 평균이 90점 이상이면 A등급 80점 이상이면 B등급 나머지는 탈락
			Scanner scanner = new Scanner(System.in);
			
			System.out.print(" 국어 점수를 입력하세요 :"); 	int 국어 = scanner.nextInt();
			System.out.print(" 영어 점수를 입력하세요 :");  	int 영어 = scanner.nextInt();
			System.out.print(" 수학 점수를 입력하세요 :");  	int 수학 = scanner.nextInt();
			int 평균 = ( 국어 + 영어 + 수학 )/3;
