...
public class Day03_2 { //c s
	...
	public static void main(String[] args) { //m s
		...
		System.out.println(" 정수1 입력: "); 		int 정수1 = scanner.nextInt();
			// int형 변수 선언 하고 입력받은 데이터를 정수로 가져와서 대입
		System.out.println(" 정수2 입력: "); 		int 정수2 = scanner.nextInt();
		...
		// [다음조건] 정수1변수가 정수2변수 보다 작으면 실행 아니면 그외
		else  					System.out.println(" 같다 ");	
		// 나머지[그외] 실행
		
		// 문제2 : 3개의 정수를 입력받아서 가장 큰수 출력
		System.out.println(" 정수3 입력: "); 		int 정수3 = scanner.nextInt(); // 변수명 중복x
		...
		System.out.println(" 정수1 입력: "); 		int 정수10 = scanner.nextInt(); 
		System.out.println(" 정수2 입력: "); 		int 정수11 = scanner.nextInt();
		System.out.println(" 정수3 입력: "); 		int 정수12 = scanner.nextInt();
		...
		System.out.println(" 정수2 입력: "); 		int 정수14 = scanner.nextInt();
		System.out.println(" 정수3 입력: "); 		int 정수15 = scanner.nextInt();
		System.out.println(" 정수4 입력: "); 		int 정수16 = scanner.nextInt();
		
		// 첫번째 값 기준 으로 비교
		if( 정수13 > 정수14 ) { int temp1 = 정수13 ; 정수13 = 정수14; 정수14 = temp1; }
		if( 정수13 > 정수15 )	{ int temp1 = 정수13 ; 정수13 = 정수15; 정수15 = temp1; }
		if( 정수13 > 정수16 )	{ int temp1 = 정수13 ; 정수13 = 정수16; 정수16 = temp1; }
		// 두번째 값 기준 으로 비교
		if( 정수14 > 정수15 )	{ int temp1 = 정수14 ; 정수14 = 정수15; 정수15 = temp1; }
		if( 정수14 > 정수16 )	{ int temp1 = 정수14 ; 정수14 = 정수16; 정수16 = temp1; }
		// 세번째 값 기준 으로 비교 x
		if( 정수15 > 정수16 )	{ int temp1 = 정수15 ; 정수15 = 정수16; 정수16 = temp1; }
		// 네번째 값 기준 으로 비교 x
