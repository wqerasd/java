...
public class Day05_1 { // c s
	...
	public static void main(String[] args) { // m s
		...
		// 2차원 배열 : 가로길이 , 세로길이
			...
			//  int int int
			//  int int int
			// * int형 변수 9개를 저장할수 있는 배열
		
		// 3차원 배열 : 가로길이 , 세로길이 , 높이
			// 형태 : 자료형[][][] 배열명 = new 자료형[열][행][높이];
